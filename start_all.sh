...
cd /home/kkw/iot_class/twiceProject/CentralPart
echo "🔨 C++ 프로젝트 빌드 확인..."
cmake --build build
...
if [ -f "build/twiceproject" ]; then
    ...
    if kill -0 $CPP_PID 2>/dev/null; then
        ...
        cd /home/kkw/iot_class/twiceProject/webPart
        
        # 가상환경 활성화 (있다면)
        if [ -f "/home/kkw/iot_class/vkkw/bin/activate" ]; then
            source /home/kkw/iot_class/vkkw/bin/activate
